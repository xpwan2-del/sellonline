...
export const adminAPI = {
  ...
  getSiteVisitSummary: (params?: Record<string, unknown>) => api.get('/admin/analytics/visits/summary', { params }),
  getSiteVisitTrends: (params?: Record<string, unknown>) => api.get('/admin/analytics/visits/trends', { params }),
  getSiteVisitSources: (params?: Record<string, unknown>) => api.get('/admin/analytics/visits/sources', { params }),
  getSiteVisitPages: (params?: Record<string, unknown>) => api.get('/admin/analytics/visits/pages', { params }),
  getSiteVisitRecent: (params?: Record<string, unknown>) => api.get('/admin/analytics/visits/recent', { params }),
  ...
  getAffiliateInviteCodes: (params?: Record<string, unknown>) => api.get('/admin/affiliate-invite-codes', { params }),
  createAffiliateInviteCode: (data: { code?: string; remark?: string }) => api.post('/admin/affiliate-invite-codes', data),
  updateAffiliateInviteCodeStatus: (id: number, data: { status: string }) =>
    api.patch(`/admin/affiliate-invite-codes/${id}/status`, data),
  getAffiliateInviteCodeUsage: (id: number) => api.get(`/admin/affiliate-invite-codes/${id}/usage`),
  getAffiliateApplications: (params?: Record<string, unknown>) => api.get('/admin/affiliate-applications', { params }),
  updateAffiliateApplicationStatus: (id: number, data: { status: string; admin_note?: string }) =>
    api.patch(`/admin/affiliate-applications/${id}/status`, data),
  getAffiliateCustomers: (id: number, params?: Record<string, unknown>) =>
    api.get(`/admin/affiliates/${id}/customers`, { params }),
  ...
  getAffiliateReportSummary: (params?: Record<string, unknown>) => api.get('/admin/affiliates/reports/summary', { params }),
  getAffiliateReportCommissions: (params?: Record<string, unknown>) => api.get('/admin/affiliates/reports/commissions', { params }),
