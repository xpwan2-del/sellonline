...
export interface AdminProduct {
  ...
  price_amount: number
  cost_price_amount: number
  affiliate_commission_rate?: number | string | null
...
export interface AdminSiteVisitSummary {
  range: string
  from: string
  to: string
  timezone: string
  kpi: {
    ...
    logged_in_rate: string
    mobile_rate: string
  }
}

export interface AdminSiteVisitTrendPoint {
  date: string
  pv: number
  uv: number
  affiliate_pv: number
...
export interface AdminSiteVisitTrend {
  range: string
  from: string
  to: string
  timezone: string
  points: AdminSiteVisitTrendPoint[]
}

export interface AdminSiteVisitSource {
  source_type: string
  pv: number
  uv: number
  rate: string
...
export interface AdminSiteVisitPageRank {
  path: string
  pv: number
  uv: number
  rate: string
...
export interface AdminSiteVisitRecent {
  id: number
  visitor_key: string
  session_key: string
  user_id: number
...
export interface AdminAffiliateUser {
  ...
  invite_code?: AdminAffiliateInviteCode
  status: string
...
export interface AdminAffiliateInviteCode {
  id: number
  code: string
  status: string
  usable: boolean
...
export interface AdminAffiliateInviteCodeUsage extends AdminAffiliateInviteCode {}
...
export interface AdminAffiliateCustomerRelation {
  id: number
...
export interface AdminAffiliateCommission {
  ...
  commission_items?: Array<{
    ...
    order_item?: { title?: LocalizedText; sku_snapshot?: { spec_values?: LocalizedText | Record<string, unknown>; sku_code?: string; [key: string]: unknown }; quantity?: number }
    sku_snapshot?: { spec_values?: LocalizedText | Record<string, unknown>; sku_code?: string; [key: string]: unknown }
    quantity: number
...
export interface AffiliateReportTopAffiliate {
  affiliate_profile_id: number
  affiliate_code: string
  email: string
  display_name: string
...
export interface AffiliateReportCommission {
  id: number
  affiliate_profile_id?: number
  affiliate_code?: string
...
export interface AffiliateReportResponse {
  ...
  top_affiliates?: AffiliateReportTopAffiliate[]
