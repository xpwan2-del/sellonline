  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/views/admin/VisitAnalytics.vue'),
        meta: { permission: 'GET:/admin/analytics/visits/summary' },
      },
      {
        path: 'forbidden',
        name: 'forbidden',
      ...
      {
        path: 'affiliates/invite-codes',
        name: 'affiliates-invite-codes',
        component: () => import('@/views/admin/AffiliateInviteCodes.vue'),
        meta: { permission: 'GET:/admin/affiliate-invite-codes' },
      },
      {
        path: 'affiliates/applications',
        name: 'affiliates-applications',
        component: () => import('@/views/admin/AffiliateApplications.vue'),
        meta: { permission: 'GET:/admin/affiliate-applications' },
      },
      {
      ...
      },
      {
        ...
        component: () => import('@/views/admin/AffiliateReports.vue'),
        meta: { permission: 'GET:/admin/affiliates/reports/summary' },
      },
      {
