...
const affiliateBadgeClass = (product: AdminProduct) => {
  if (!product.is_affiliate_enabled) return 'border-border bg-muted/30 text-muted-foreground'
  if (product.affiliate_commission_rate === null || product.affiliate_commission_rate === undefined || product.affiliate_commission_rate === '') {
    return 'border-sky-200 bg-sky-50 text-sky-700'
  }
  return 'border-emerald-200 bg-emerald-50 text-emerald-700'
}

const affiliateBadgeLabel = (product: AdminProduct) => {
  if (!product.is_affiliate_enabled) return t('admin.products.affiliate.disabled')
  if (product.affiliate_commission_rate === null || product.affiliate_commission_rate === undefined || product.affiliate_commission_rate === '') {
    return t('admin.products.affiliate.default')
  }
  return t('admin.products.affiliate.custom', { rate: Number(product.affiliate_commission_rate || 0).toFixed(2) })
}
                ...
                <div class="min-w-0 flex-1">
                  ...
                  <div class="mt-2 flex flex-wrap gap-2">
                    ...
                    <span
                      ...
                      :class="affiliateBadgeClass(product)"
                    >
                      {{ affiliateBadgeLabel(product) }}
                    </span>
                    <span
