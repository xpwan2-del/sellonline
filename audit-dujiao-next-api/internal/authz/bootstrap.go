	...
	return []RoleSeed{
		...
		},
		{
			...
			Policies: []Policy{
				...
				{Object: "/admin/affiliate-invite-codes", Action: "POST"},
				{Object: "/admin/affiliate-invite-codes/:id/status", Action: "PATCH"},
				{Object: "/admin/affiliate-applications/:id/status", Action: "PATCH"},
				// 会员等级管理
		...
		},
		{
			...
			Policies: []Policy{
				...
				{Object: "/admin/affiliates/reports/summary", Action: "GET"},
				{Object: "/admin/affiliates/reports/commissions", Action: "GET"},
