...
// 推广返利代理来源常量
const (
	AffiliateProfileSourcePlatformInvite = "platform_invite"
)

// 平台代理邀请码状态常量
const (
	AffiliateInviteCodeStatusActive   = "active"
	AffiliateInviteCodeStatusUsed     = "used"
	AffiliateInviteCodeStatusDisabled = "disabled"
)

// 平台代理申请状态常量
const (
	AffiliateAgentApplicationStatusPending   = "pending"
	AffiliateAgentApplicationStatusContacted = "contacted"
	AffiliateAgentApplicationStatusRejected  = "rejected"
)

// 买家代理归属来源常量
const (
	AffiliateCustomerRelationSourceRegister = "register"
	AffiliateCustomerRelationSourceOrder    = "order"
)
