...
type CreateProductRequest struct {
	...
	PriceAmount             float64                  `json:"price_amount" binding:"required"`
	CostPriceAmount         float64                  `json:"cost_price_amount"`
	AffiliateCommissionRate *float64                 `json:"affiliate_commission_rate"`
...
func (h *Handler) CreateProduct(c *gin.Context) {
	...
	product, err := h.ProductService.Create(service.CreateProductInput{
		...
		AffiliateCommissionRate: toOptionalDecimal(req.AffiliateCommissionRate),
		...
		SoldCountOffset:         req.SoldCountOffset,
