...
type UserRegisterRequest struct {
	...
	AgentInvite         string `json:"agent_invite"`
...
func (h *Handler) UserRegister(c *gin.Context) {
	...
	user, token, expiresAt, err := h.UserAuthService.RegisterWithAffiliate(req.Email, req.Password, req.Code, req.AgreementAccepted, emailVerificationEnabled, service.UserRegisterAffiliateInput{
		AgentInvite:         req.AgentInvite,
	...
	if err != nil {
		...
		case errors.Is(err, service.ErrAffiliateRegisterParamsConflict):
