...
type Container struct {
	...
	SiteVisitRepo          repository.SiteVisitRepository
	AffiliateRepo          repository.AffiliateRepository
	AffiliateReportRepo    repository.AffiliateReportRepository
	...
	SiteVisitService          *service.SiteVisitService
	NotificationService       *service.NotificationService
	AffiliateService          *service.AffiliateService
	AffiliateReportService    *service.AffiliateReportService
...
func (c *Container) initRepositories() {
	...
	c.SiteVisitRepo = repository.NewSiteVisitRepository(db)
	c.AffiliateRepo = repository.NewAffiliateRepository(db)
	c.AffiliateReportRepo = repository.NewAffiliateReportRepository(db)
...
func (c *Container) initServices() {
	...
	c.UserAuthService.SetAffiliateRepository(c.AffiliateRepo)
	...
	c.AffiliateReportService = service.NewAffiliateReportService(c.AffiliateReportRepo, c.AffiliateRepo, c.UserRepo)
	...
	c.SiteVisitService = service.NewSiteVisitService(c.SiteVisitRepo)
