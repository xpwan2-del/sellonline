...
// AffiliateAgentApplicationListFilter 查询平台代理申请列表的过滤条件
type AffiliateAgentApplicationListFilter struct {
	Page     int
	PageSize int
	Status   string
	Keyword  string
...
// AffiliateInviteCodeListFilter 平台代理邀请码列表过滤条件
type AffiliateInviteCodeListFilter struct {
	Page     int
	PageSize int
	Status   string
	Keyword  string
...
// AffiliateCustomerRelationListFilter 代理商客户关系列表过滤条件
type AffiliateCustomerRelationListFilter struct {
	Page               int
	PageSize           int
