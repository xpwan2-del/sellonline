...
var (
	...
	ErrAffiliateReportRangeInvalid         = errors.New("affiliate report range invalid")
	...
	ErrAffiliateSelfOpenNotAllowed         = errors.New("affiliate self open not allowed")
	ErrAffiliateInviteCodeInvalid          = errors.New("affiliate invite code invalid")
	ErrAffiliateInviteCodeUnavailable      = errors.New("affiliate invite code unavailable")
	ErrAffiliateRegisterParamsConflict     = errors.New("affiliate register params conflict")
	ErrAffiliateAgentApplicationInvalid    = errors.New("affiliate agent application invalid")
	ErrAffiliateAgentApplicationExists     = errors.New("affiliate agent application exists")
