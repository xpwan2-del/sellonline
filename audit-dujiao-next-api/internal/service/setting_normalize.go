...
func normalizeSiteContact(raw interface{}) map[string]interface{} {
	...
	result["qq_number"] = normalizeSettingText(contactMap["qq_number"])
	result["qq_group"] = normalizeSettingText(contactMap["qq_group"])
	result["qq_qr_image"] = normalizeSettingText(contactMap["qq_qr_image"])
