      ...
      <div
        ...
        <div v-if="hasContact">
          ...
          <div v-if="hasContactLinks" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <a v-if="contactConfig?.qq_group" :href="contactConfig.qq_group" target="_blank" rel="noopener noreferrer"
              ...
              <svg class="w-6 h-6 text-sky-500" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <span class="font-bold">QQ 群</span>
            </a>
...
const hasContactLinks = computed(() => !!(contactConfig.value?.qq_group || contactConfig.value?.telegram || contactConfig.value?.whatsapp))
