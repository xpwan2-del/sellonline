...
const canSubmit = computed(() => {
  ...
  if (!guestPassword.value.trim() || !guestEmailValid.value) return false
...
const submitBlockedReason = computed(() => {
  ...
  if (!guestPassword.value.trim()) return t('checkout.errors.missingGuest')
...
const loadPreview = async () => {
  ...
  if (isGuestCheckout.value && (!guestPassword.value.trim() || !guestEmailValid.value)) {
    preview.value = null
    orderPaymentChannels.value = []
    previewError.value = ''
    couponRefreshing.value = false
