  ...
  <div class="products-page min-h-screen theme-page pt-20 pb-16">
    <div class="container mx-auto px-2 sm:px-4">
      ...
      <div class="flex flex-col lg:flex-row gap-8">
        ...
        <main class="flex-1">
          <!-- Loading Skeleton -->
          <div v-if="loading" class="grid grid-cols-2 gap-2 sm:gap-3 md:gap-4 md:grid-cols-3 lg:grid-cols-4">
          ...
          <div v-else-if="products.length > 0">
            <div class="grid grid-cols-2 gap-2 sm:gap-3 md:gap-4 md:grid-cols-3 lg:grid-cols-4">
              <ProductCard
